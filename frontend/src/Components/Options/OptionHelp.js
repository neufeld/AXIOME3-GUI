...
import {
	...
	MORE_DETAIL,
	ORDINATION_COLLAPSE_LEVEL_HELP,
	WEIGHTED_AVERAGE_COLLAPSE_LEVEL_HELP,
	DISSMILARITY_INDEX_HELP,
...
export const getTooltipText = (label) => {
	switch(label) {
		...
		case WEIGHTED_AVERAGE_COLLAPSE_LEVEL:
			return WEIGHTED_AVERAGE_COLLAPSE_LEVEL_HELP
		case DISSMILARITY_INDEX:
			return DISSMILARITY_INDEX_HELP
		case ABUNDANCE_THRESHOLD:
			return ABUNDANCE_THRESHOLD_HELP
		case R2_THRESHOLD:
